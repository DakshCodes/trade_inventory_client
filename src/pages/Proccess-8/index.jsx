...
import P8Form from './Proccess-form.';
...
const Proccess8 = () => {
    ...
    return (
        <div>
            ...
            {setShowP2Form && <P8Form rawMaterials={rawMaterials} selectedProcessID={selectedProcessID} MaterialTypes={MaterialTypes} getData={getData} setShowP2Form={setShowP2Form} showP2Form={showP2Form} selectedProduct={selectedProduct} />}
        </div>
    )
}

export default Proccess8;
