...
const P4Form = ({ rawMaterials, setShowP2Form, showP2Form, getData, selectedProcessID, MaterialTypes, getDataType, selectedProduct }) => {
    ...
    useEffect(() => {
        if (selectedProduct) {
            ...
            formRef?.current?.setFieldsValue(selectedProduct.stage[3] || selectedProduct.stage[2])
        }
    }, [selectedProduct])
