...
import P10Form from './Proccess-form.';
...
const Proccess10 = () => {
    ...
    const handleNextProcess = async (id) => {
        try {
            ...
            if (response.success) {
                message.success("Product has been transferred to summary stage")
                getData();
            }
        } catch (error) {
            dispatch(SetLoader(false));
        ...
        try {
            ...
            if (response.success) {
                let products = response.data.filter((data) => {
                    return data.nextStageValues === 10;
                })
    ...
    return (
        <div>
            ...
            {setShowP2Form && <P10Form rawMaterials={rawMaterials} selectedProcessID={selectedProcessID} MaterialTypes={MaterialTypes} getData={getData} setShowP2Form={setShowP2Form} showP2Form={showP2Form} selectedProduct={selectedProduct} />}
        </div>
    )
}

export default Proccess10;
