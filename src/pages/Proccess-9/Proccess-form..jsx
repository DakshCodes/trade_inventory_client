...
const P9Form = ({ rawMaterials, setShowP2Form, showP2Form, getData, selectedProcessID, MaterialTypes, getDataType, selectedProduct }) => {
    ...
    useEffect(() => {
        if (selectedProduct) {
            ...
            formRef?.current?.setFieldsValue(selectedProduct.stage[8] || selectedProduct.stage[7])
        }
    }, [selectedProduct])
