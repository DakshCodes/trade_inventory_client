...
const P7Form = ({ rawMaterials, setShowP2Form, showP2Form, getData, selectedProcessID, MaterialTypes, getDataType, selectedProduct }) => {
    ...
    useEffect(() => {
        if (selectedProduct) {
            ...
            formRef?.current?.setFieldsValue(selectedProduct.stage[6] || selectedProduct.stage[5])
        }
    }, [selectedProduct])
    ...
    const onFinish = async (values) => {
        ...
        try {
            ...
            if (selectedProduct.stage[6]) {
                response = await EditProductOnceInitialised(selectedProduct._id, values, 6);
            }
            else {
