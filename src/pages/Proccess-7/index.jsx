...
import P7Form from './Proccess-form.';
...
const Proccess7 = () => {
    ...
    return (
        <div>
            ...
            {setShowP2Form && <P7Form rawMaterials={rawMaterials} selectedProcessID={selectedProcessID} MaterialTypes={MaterialTypes} getData={getData} setShowP2Form={setShowP2Form} showP2Form={showP2Form} selectedProduct={selectedProduct} />}
        </div>
    )
}

export default Proccess7;
