...
const P6Form = ({ rawMaterials, setShowP2Form, showP2Form, getData, selectedProcessID, MaterialTypes, getDataType, selectedProduct }) => {
    ...
    useEffect(() => {
        if (selectedProduct) {
            ...
            formRef?.current?.setFieldsValue(selectedProduct.stage[5] || selectedProduct.stage[4])
        }
    }, [selectedProduct])
    ...
    const onFinish = async (values) => {
        ...
        try {
            ...
            if (selectedProduct.stage[5]) {
                response = await EditProductOnceInitialised(selectedProduct._id, values, 5);
            }
            else {
